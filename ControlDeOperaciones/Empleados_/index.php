...
$consulta = "Call spPersonalMostrar();";
...
<div class="container" id="Contenido">
        <div class="row">
            <div class="col-lg-12">            
            <button id="btnNuevo" type="button" class="btn btn-success" data-toggle="modal" title='Ingresar nuevo insumo' name="Nuevo">Nuevo personal</button>    
            </div>    
        </div>    
    </div>    
    <br>  
                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                            <td data-label="Id"><?php echo $dat['PersonalId'] ?></td>
                                <td data-label="Area"><?php $IdArea = $dat['AreaID'];
                                //Seleccionar area
                                 $consult = "Call spAreaBuscarId('$IdArea');";
                                 ...
                                 echo $dt[0]['Area']; /*var_dump($dt);*/?></td>
                                <td data-label="Nombre completo"><?php echo $dat['PersonalNo'] ?></td>
                                <td data-label="Puesto"><?php echo $dat['PersonalPu'] ?></td>   
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPersonas">    
            <div class="modal-body">
                ...
                <input title='Selecciona una nueva area a asignar' type="text" class="form-control" id="PersonalNo" required>
                
                </div>
                <div class="form-group">
                <label for="modelo" class="col-form-label">Puesto:</label>
                <input title='Puesto al que pertenecera' type="text" class="form-control" id="PersonalPu" required>
                </div>                
                <div class="form-group">
                <!--Datos para agregar no editables-->
                <input type="text" id="PersonalId" hidden>
                <input type="text" id="Estatus" hidden>
                </div> 
                <div class="form-group">
                 <label for="AreaIDe" class="col-form-label">Area a la que pertenecera:</label>
                 <?php // Consultar la base de datos
                  ...
                  echo "<option id='".$dto['AreaID']."' name='".$dto['AreaID']."' class=col-form-label  value='".$dto['Area']."'>".$dto['Area']."</option>";
...
<script>
	...
	contextMenu.addItem("Nuevo empleado", 
          function(){
