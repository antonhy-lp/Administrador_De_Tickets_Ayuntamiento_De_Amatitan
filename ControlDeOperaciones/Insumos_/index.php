                ...
                <div class="col-lg-12">
                    <div class="table-responsive">        
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                            <td data-label="ID insumo"><?php echo $dat['idInsumo'] ?></td>
                                <td data-label="Nombre"><?php echo $dat['Nombre'] ?></td>
                                <td data-label="Modelo"><?php echo $dat['Modelo'] ?></td>
                                <td data-label="Descripcion"><?php echo $dat['Descripcion'] ?></td>   
                                <td data-label="Fecha de registro"><?php echo $dat['FechaRegistro'] ?></td>   
                                <td data-label="Fecha de salida" id="textFechaSalida"><?php echo $dat['FechaSalida'] ?></td>
                                <td data-label="Estado" id="textEstado"><?php if( $dat['Estatus']==1){
                                   $E ="Activo";
                                }else if($dat['Estatus']==0){
                                    $E ="Inactivo";
                                } echo $E; ?></td>
                                <td data-label="Destino"><?php echo $dat['Destino'] ?></td>
                                <td data-label="Unidades"><?php echo $dat['Unidades'] ?></td>    
                                <td></td>
                            </tr>
                            <?php
                                }
    ...
    <div class="modal-dialog" role="document">
        ...
        <form id="formPersonas">    
            <div class="modal-body">
                ...
                <input type="text" id="idInsumo" hidden>
                ...
                <div class="form-group">
                <label for="descripcion" class="col-form-label">Ubicacion:</label>
                <input  class="form-control" id="destino">
                </div>            
            </div>
